              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('🚩 Ardabil', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w300),),
                      const SizedBox(height: 8,),
                      const Text('Good Morning', style: TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold),),
                      Image.asset('assets/images/1.png'),
                      const Center(child: Text('20°C', style: TextStyle(color: Colors.white, fontSize: 55, fontWeight: FontWeight.w600),),),
                      const Center(child: Text('Sunny', style: TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.w500),)),
                      const SizedBox(height: 5,),
                      const Center(child: Text('Friday 16 - 09.41 am', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w300),)),
                            ...
                            children: [
                              ...
                              const Column(
                                ...
                                children: [
                                  ...
                                  Text('20°C', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700),),
                            ...
                            children: [
                              ...
                              const Column(
                                ...
                                children: [
                                  ...
                                  Text('10°C', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700),),
